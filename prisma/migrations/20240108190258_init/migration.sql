...
CREATE TABLE "new_Jogos_Grupo" (
    ...
    "timestamp_jogo" DATETIME NOT NULL,
    "descricao_jogo" TEXT,
...
INSERT INTO "new_Jogos_Grupo" ("data_criacao", "data_jogo", "descricao_jogo", "horario_jogo", "id", "id_grupo", "timestamp_jogo") SELECT "data_criacao", "data_jogo", "descricao_jogo", "horario_jogo", "id", "id_grupo", "timestamp_jogo" FROM "Jogos_Grupo";
